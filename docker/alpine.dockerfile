...
ARG FILC_VERSION=0.685
ARG FILC_SHA256=d12bd30c33f18179a9355b32ea44ba61dcc0342c7d77d1ac2548852e64994727
...
RUN mkdir /build/install && \
    ...
    cp build/licenses/LICENSE* /build/install/ && \
